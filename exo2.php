...
class Encounter {
    ...
    public static function probabilityAgainst(Player $playerOne, Player $againstPlayerTwo)
    {
        return 1/(1+(10 ** (($againstPlayerTwo->level - $playerOne->level)/400)));
    }
    ...
    public static function setNewLevel(Player &$playerOne, Player $againstPlayerTwo, int $playerOneResult)
    {
        ...
        $playerOne->level += (int) (32 * ($playerOneResult - self::probabilityAgainst($playerOne, $againstPlayerTwo)));
    }
}
